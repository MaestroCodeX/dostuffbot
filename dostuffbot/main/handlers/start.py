...
def start_command(bot, update):
    ...
    sent_message = message.reply_text(texts.START, parse_mode=ParseMode.MARKDOWN, reply_markup=keyboards.START_M)
...
def start(bot, update):
    ...
    sent_message = query.message.reply_text(texts.START, parse_mode=ParseMode.MARKDOWN, reply_markup=keyboards.START_M)
